...
var SideMenu = function (_Component) {
  ...
  function SideMenu(props) {
    ...
    _this.onClickDictionary = {};

    _this.state = { itemTree: [], componentStateTree: [], activeItem: props.activeItem };
    return _this;
  }
  ...
  _createClass(SideMenu, [{
    ...
    value: function buildTree(children, parent) {
      ...
      return children.map(function (child) {
        ...
        if (newChild.value === activeItem) {
          ...
          _this4.activeParentPath(newChild);
        }

        if (Array.isArray(child.children)) {
          //$FlowFixMe
          subTree = _this4.buildTree(child.children, newChild);
        }
        newChild.children = subTree;
    ...
    value: function deactivateTree(itemTree) {
      ...
      itemTree.forEach(function (item) {
        item.active = false;
        if (item.children) {
          _this5.deactivateTree(item.children);
        }
      });
    }
  }, {
    ...
    value: function onItemClick(item) {
      ...
      return function (e) {
        ...
        _this6.setState(_extends({}, _this6.state, { activeItem: item.value }));
      };
    }
  }, {
    key: 'renderChevron',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          item.children && item.children.map(function (child) {
            return _this7.renderItem(child, level + 1);
          })
        )
      );
    }
      ...
      if (!componentStateTree || componentStateTree.length == 0) {
        ...
        return _react2.default.createElement(
          ...
          itemTree && itemTree.map(function (item) {
            return _this8.renderItem(item, 1);
          })
        );
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.Children.map(this.props.children, function (child, index) {
          return _react2.default.cloneElement(child, {
            ...
            handleComponentClick: _this8.handleComponentClick.bind(_this8),
  ...
  _createClass(Item, [{
    ...
    value: function onItemClick() {
      var _props4 = this.props,
          ...
          sidemenuComponent = _props4.sidemenuComponent,
